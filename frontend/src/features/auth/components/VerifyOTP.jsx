...
const VerifyOTP = () => {
  ...
  const { loading, error, emailForVerification, isAuthenticated } = useSelector((state) => state.auth);
  ...
  const handleSubmit = async (e) => {
    ...
    setSuccess('');
    const result = await dispatch(verifyOTP({ email: emailForVerification, otp: otpString }));
